 ...
 * @OA\Info(
 *  version="1.0.0",
 *  title="Documentacion de API de Rafael Angel Aquino Hernández",
 *  description="API desarrollada por Rafael Angel Aquino Hernández, para la UFG",
 *  @OA\Contact(
 *      email="ia.rafaelhernandez@ufg.edu.sv"
 *      ),
 *  @OA\License(
 *      name="Apache 2.0",
